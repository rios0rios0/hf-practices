...
- refreshed `CLAUDE.md` and `.github/copilot-instructions.md` to document the added `claude-review.yaml` and `claude-mention.yaml` workflows alongside `release.yaml`
